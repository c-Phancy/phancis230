...
@section('content')
<header class="h1 text-center">Create a Character</header>
@if($errors->any())
...
<form method="POST" action="{{ route('characters.store') }}" enctype="multipart/form-data">
    ...
    <div class="btn-group-vertical">
        <button type="submit" class="btn store-button" id="submit-button">Store Character</button>
        <a href="{{ route('characters.index') }}" class="btn store-button"
